...
---Data Analysis & Business Key Problemm & Answers 

--My Analysis Findings
Q1 Write a SQL query to retrieve all columns for sales made on '2022-07-09
Q2 Write a SQL query to retrieve all transactions where the category is 'Clothing' and the quantity sold is more than 4 in the month of Feb-2022
...
Q7 Write a SQL query to find the total number of transactions (transaction_id) made by each gender
...
---Q9 Write a SQL query to find the top 6 customers based on the highest total sales
